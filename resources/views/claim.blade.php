...
<body>
    ...
    <div class="container mt-4">
        <div class="banner">
            <strong>Finish claiming your free page.</strong> Then redeem your $300 credit when you start Yelp Ads.
        </div>
        <div class="row">
            <div class="col-md-6 mt-5">
                <div class="search-container">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <button class="btn btn-danger" type="button"><a href="{{asset('frontend/addbusiness.html')}}" class="text-decoration-none text-light">Search</a></button>
                    </div>
                </div>
            </div>
            <div class="col-md-6 mt-5">
