<header>
  <nav class="navbar navbar-expand-lg  navbar-light  navv">
    <div class="container-fluid">
      <a class="navbar-brand me-5 text-light" href="{{asset('frontend/index.html')}}">
        ...
        <ul class="navbar-nav mb-2 mb-lg-0">
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li><a class="dropdown-item" href="{{asset('frontend/addbusiness.html')}}"><i class="bi bi-house-add-fill me-3"></i>Add a business</a></li>
              <li><a class="dropdown-item" href="{{asset('frontend/claim.html')}}"><i class="bi bi-check2-circle me-3"></i>Claim your business</a></li>
              <li><a class="dropdown-item" href="{{asset('frontend/login.html')}}"><i class="bi bi-person-circle me-3"></i>Log in to Business Account</a></li>
              <li>
                <hr class="dropdown-divider">
              </li>
              <li><a class="dropdown-item" href="{{asset('frontend/Explore.html')}}"><i class="bi bi-search me-3"></i>Explore help for Business</a></li>
            </ul>
          </li>
          <li class="nav-item">
            <a class="nav-link me-2 active text-light navver" aria-current="page" href="{{asset('frontend/review.html')}}">Write a Review</a>
          </li>
          <li class="nav-item">
            <a class="nav-link me-3  text-light navver" href="{{asset('frontend/project.html')}}">Start a Project</a>
          </li>
          <li class="nav-item ">
        ...
        <ul class="navbar-nav">
            ...
            <ul class="dropdown-menu second-menu">
              <div class="content_1 d-flex">
                <div class="sub-nav-col left me-4">
                  <a href="{{asset('frontend/Takeout.html')}}" class="sub-nav-box  text-decoration-none text-dark" id="box-1">

                    <h4 class="leftt"> <span class="leftt">🗑</span>Takeout</h4>

                  </a>
                  <a href="{{asset('frontend/Takeout.html')}}" class="sub-nav-box text-decoration-none text-dark" id="box-2">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu second-menu">
              <div class="content_1 d-flex">
                <div class="sub-nav-col left me-4">
                  <a href="{{asset('frontend/contractor.html')}}" class="sub-nav-box  text-decoration-none text-dark" id="box-1">
